...
def initilization_of_population(size, c_size):
	population = []
	for i in range(size):
		# ----------------- With bytes -----------------
...
def generations(size, c_size, n_parents, mutation_rate, n_gen):
	best_chromo = []
	best_score = []
	population_nextgen = initilization_of_population(size, c_size)
...
chromo,score=generations(size = 15, # Population size
